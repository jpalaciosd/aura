...
async function getAIResponse(messages: Message[]): Promise<string> {
  try {
    ...
    return "Disculpa, tuve un problema técnico. 😅 Escríbenos por WhatsApp al +57 314 891 5903 y te atendemos de inmediato.";
  }
}
        ...
        {open && (
          ...
          >
            ...
            <div className="px-4 pb-3 text-center">
              <a
                href="https://wa.me/573148915903?text=Hola%20AURA%2C%20quiero%20agendar%20una%20cita"
                target="_blank"
                rel="noopener"
